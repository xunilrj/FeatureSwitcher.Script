...
Target "RestorePackages" (fun _ ->
    "./Sources/MachinaAurum.FeatureSwitcher.Script.sln"
...
Target "CreatePackage" (fun _ ->
    ...
    NuGetPack (fun p -> 
        {p with
            ...
            Project = "Feature.Switcher.Script"
            Description = "Allow configuration of featuresusing scripts (currently just javascript)"                               
            OutputPath = buildDir @@ "nuget"
            Summary = "Allow configuration of featuresusing scripts (currently just javascript)" 
            WorkingDir = buildDir
            Version = gitVersion
            AccessKey = "myAccesskey"
            Publish = true }) "Feature.Switcher.Script.nuspec"
)
